...
class ReportAccountConsolidatedJournal(models.AbstractModel):
    ...
    def get_options(self, previous_options=None):
        options = super(ReportAccountConsolidatedJournal, self).get_options(previous_options=previous_options)
