            ...
            sql = """WITH account_move_line AS (
              ...
              (
               ...
               SELECT aml.id, ref.date, aml.name,
                 ...
                 aml.amount_residual, aml.partner_id, aml.reconciled, aml.company_id, aml.company_currency_id, aml.amount_currency, aml.balance, acc.user_type_id, aml.analytic_account_id, aml.display_type
        ...
        for account in sorted_accounts:
            ...
            if 'account_%s' % (account.id,) in options.get('unfolded_lines') or unfold_all:
                ...
                for line in amls:
                    ...
                    if line.move_id.type in ('in_refund', 'in_invoice'):
                        caret_type = 'account.invoice.in'
                    elif line.move_id.type in ('out_refund', 'out_invoice'):
