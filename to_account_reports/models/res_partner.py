...
class ResPartner(models.Model):
    ...
    def message_post(self, body='', subject=None, message_type='notification',
        ...
        if parent_id:
            ...
            if subtype_xmlid and parent.subtype_id == followup_subtype:
                subtype_xmlid = 'to_account_reports.followup_logged_action'

        return super(ResPartner, self).message_post(
                body=body, subject=subject, message_type=message_type, subtype_xmlid=subtype_xmlid,
