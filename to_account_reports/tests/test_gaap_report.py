...
class GAAPReport(Common):
    ...
    def test_01_validate_gaap_report(self):
        ...
        ------------------------------------------------------------------------------|-----------|
        """
        lines = self._get_lines_report(self.AccountCashFlowReport, datetime(2021, 8, 17, 12, 0), 'this_year', cash_basis=True)
        table_value = [
        ...
        Cash in                                                                       | 70000     |
        Cash out                                                                      | -50000    |
        Minus previously recorded advance payments (already in the starting balance)  | -9000     |
        ------------------------------------------------------------------------------|-----------|
        Net increase in cash and cash equivalents                                     | 20000     |
        ------------------------------------------------------------------------------|-----------|
        Cash and cash equivalents, beginning of period                                |           |
...
\t\t\t''', -9000),
        ...
        Cash out                                                                      |           |
        ------------------------------------------------------------------------------|-----------|
        Total Cash flows from unclassified activities                                 | 93800     |
        ------------------------------------------------------------------------------|-----------|
        Cash in                                                                       | 195000    |
        Cash out                                                                      | -101200   |
        Minus previously recorded advance payments (already in the starting balance)  | -9000     |
...
\t\t\t''', -9000),
        ...
        Cash out                                                                      |           |
        ------------------------------------------------------------------------------|-----------|
        Total Cash flows from unclassified activities                                 | 93920     |
        ------------------------------------------------------------------------------|-----------|
        Cash in                                                                       | 195120    |
        Cash out                                                                      | -101200   |
        Minus previously recorded advance payments (already in the starting balance)  | -9000     |
...
\t\t\t''', -9000),
        ...
        Line Items                                                                    | 2021      |
        ------------------------------------------------------------------------------|-----------|
        Total Cash flows from operating activities                                    | -10870    |
        ------------------------------------------------------------------------------|-----------|
        ...
        Cash in                                                                       | 195120    |
        Cash out                                                                      | -101200   |
        Minus previously recorded advance payments (already in the starting balance)  | -4000     |
        ------------------------------------------------------------------------------|-----------|
        Net increase in cash and cash equivalents                                     | 79050     |
        ------------------------------------------------------------------------------|-----------|
        Cash and cash equivalents, beginning of period                                |           |
...
\t\t\t''', -4000),
        ...
        """
        |-------------------------------------------------|
        |Expect value (Cash Flow with cash basis is False)|
        |-------------------------------------------------|
