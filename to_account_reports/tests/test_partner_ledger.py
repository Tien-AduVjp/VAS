...
class PartnerLedger(Common):
    ...
    def test_01_validate_partner_ledger(self):
        ...
        table_value = [
            ('Vendor A', 0, 0, 0, 0, 0, 0, 0, 10, -10),
            ('Total'   , 0, 0, 0, 0, 0, 0, 0, 10, -10),
        ]
        ...
        table_value = [
            ('Vendor A', 0, 0, 0, 0, 0, -10, 0, 5, -15),
            ('Total'   , 0, 0, 0, 0, 0, -10, 0, 5, -15),
        ]
        self._check_report_value(lines, table_value)
        ...
        table_value = [
            ('Vendor A', 0, 0, 0, 0, 0, -15, 5, 0, -10),
            ('Total'   , 0, 0, 0, 0, 0, -15, 5, 0, -10),
        ]
        self._check_report_value(lines, table_value)
        ...
        table_value = [
            ('Vendor A', 0, 0, 0, 0, 0, -10, 10, 0, 0),
            ('Total'   , 0, 0, 0, 0, 0, -10, 10, 0, 0),
        ]
        self._check_report_value(lines, table_value)
    ...
    def test_02_validate_partner_ledger(self):
        ...
        |------------|
                        ...
                        |  |  |  |  |  | Initial Balance | Debit | Credit | Balance |
        ----------------|--|--|--|--|--|-----------------|-------|--------|---------|
        Customer A      |  |  |  |  |  | 0               | 10    | 0      | 10      |
        ----------------|--|--|--|--|--|-----------------|-------|--------|---------|
        Total           |  |  |  |  |  | 0               | 10    | 0      | 10      |
        """
        lines = self._get_lines_report(self.AccountPartnerLedger, datetime(2021, 8, 11, 12, 0), 'this_year')
        table_value = [
            ('Customer A', 0, 0, 0, 0, 0, 0, 10, 0, 10),
            ('Total'   , 0, 0, 0, 0, 0, 0, 10, 0, 10),
        ]
        self._check_report_value(lines, table_value)
        ...
        |------------|
                        ...
                        |  |  |  |  |  | Initial Balance | Debit | Credit | Balance |
        ----------------|--|--|--|--|--|-----------------|-------|--------|---------|
        Customer A      |  |  |  |  |  | 10              | 5     | 0      | 15      |
        ----------------|--|--|--|--|--|-----------------|-------|--------|---------|
        Total           |  |  |  |  |  | 10              | 5     | 0      | 15      |
        """
        lines = self._get_lines_report(self.AccountPartnerLedger, datetime(2021, 8, 12, 12, 0), 'custom', date(2021, 8, 12), date(2021, 12, 31))
        table_value = [
            ('Customer A', 0, 0, 0, 0, 0, 10, 5, 0, 15),
            ('Total'   , 0, 0, 0, 0, 0, 10, 5, 0, 15),
        ]
        self._check_report_value(lines, table_value)
        ...
        |------------|
                        ...
                        |  |  |  |  |  | Initial Balance | Debit | Credit | Balance |
        ----------------|--|--|--|--|--|-----------------|-------|--------|---------|
        Customer A      |  |  |  |  |  | 15              | 0     | 5      | 10      |
        ----------------|--|--|--|--|--|-----------------|-------|--------|---------|
        Total           |  |  |  |  |  | 15              | 0     | 5      | 10      |
        """
        lines = self._get_lines_report(self.AccountPartnerLedger, datetime(2021, 8, 13, 12, 0), 'custom', date(2021, 8, 13), date(2021, 12, 31))
        table_value = [
            ('Customer A', 0, 0, 0, 0, 0, 15, 0, 5, 10),
            ('Total'   , 0, 0, 0, 0, 0, 15, 0, 5, 10),
        ]
        self._check_report_value(lines, table_value)
        ...
        lines = self._get_lines_report(self.AccountPartnerLedger, datetime(2021, 8, 14, 12, 0), 'custom', date(2021, 8, 14), date(2021, 12, 31))
        table_value = [
            ('Customer A', 0, 0, 0, 0, 0, 10, 0, 10, 0),
            ('Total'   , 0, 0, 0, 0, 0, 10, 0, 10, 0),
        ]
        self._check_report_value(lines, table_value)
