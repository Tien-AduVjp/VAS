{
    'name': "Documents - HR Contract",
    'name_vi_VN': "Quản lý Tài liệu Hợp đồng lao động",

    'summary': """
HR Contract Documents""",

    'summary_vi_VN': """
Quản lý Tài liệu Hợp đồng lao động""",

    'description': """

What it does
============
This bridge module between Document Management System and HR Contract.
...
Mô tả
=====
Mô đun cầu nối giữa Quản lý tài liệu và Hợp đồng lao động.
...
2. Ấn bản Enterprise
    ...
    'version': '0.1.0',
    'depends': ['viin_document_hr','hr_contract'],
    'data': [
    ...
    'demo': [
        'demo/document_workspace_data.xml',
