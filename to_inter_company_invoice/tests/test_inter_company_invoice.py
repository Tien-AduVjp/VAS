...
class TestInterCompanyInvoice(SavepointCase):
    ...
    def _generate_account_move(self, partner_id, company_id, type, journal_id, account_id, user = None):
    ...
    def test_01a_auto_generate_inter_company_purchase_invoice(self):
        ...
        self.assertTrue(len(inter_comp_customer_invoice) == 1 and inter_comp_customer_invoice.type == 'in_invoice',
    ...
    def test_02a_auto_generate_inter_company_sale_invoice(self):
        ...
        self.assertTrue(len(inter_comp_vendor_invoice) == 1 and inter_comp_vendor_invoice.type == 'out_invoice',
    ...
    def test_03a_auto_generate_inter_company_credit_note_invoice(self):
        ...
        self.assertTrue(len(inter_comp_vendor_credit_note_invoice) == 1 and inter_comp_vendor_credit_note_invoice.type == 'out_refund',
    ...
    def test_04a_auto_generate_inter_company_refund_invoice(self):
        ...
        self.assertTrue(len(inter_comp_vendor_refund_invoice) == 1 and inter_comp_vendor_refund_invoice.type == 'in_refund',
