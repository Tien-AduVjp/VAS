...
class WebsiteAffiliateRegister(http.Controller):
    ...
    def affiliate_register(self, user=None, **kwargs):
        ...
        medium = request.env['utm.medium'].sudo().search([('active', '=', True)])
    ...
    @http.route(['/affiliate/commissions'], type='http', auth="user", website=True)
    ...
    @http.route(['/affiliate/payment_requests', '/affiliate/payment_requests/<int:request_id>'], type='http', auth="user", website=True)
    def affiliate_payment_requests(self, request_id=None, **kwargs):
        ...
        if user and user.partner_id.is_affiliate:
            ...
            requests = request.env['affiliate.payment'].sudo().search([('user_id.id', '=', user.partner_id.id)])
    ...
    @http.route(['/affiliate/payment_requests/new'], type='http', auth="user", website=True)
    ...
    @http.route(['/affiliate/invoices', '/affiliate/invoices/page/<int:page>'], type='http', auth="user", website=True)
    ...
    @http.route(['/affiliate/create_link'], type='http', auth="public", website=True)
