...
class PurchaseOrder(models.Model):
    ...
    def button_confirm(self):
        ...
        if launch_confirmation_wizard and self.env.user.has_group('to_purchase_backdate.group_purchase_backdate'):
    ...
    def action_confirmation_wizard(self):
        self.ensure_one()
        action = self.env['ir.actions.act_window']._for_xml_id('to_purchase_backdate.action_wizard_confirm_purchase')
