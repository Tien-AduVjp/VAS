    ...
    def test_00_get_product_price(self):
        ...
        def _check_pricelist(price_discount):
            self.assertEqual(price_discount,
                             self.pricelist_1.get_product_price(self.product_1, 1, self.partner_1, '2021-08-18'),
            ...
            self.assertEqual(10000000,
                             self.pricelist_1.get_product_price(self.product_1, 1, self.partner_1, '2021-08-12'),
                             'to_product_pricelist_weekdays: Pricelist not working')
            self.assertEqual(20000000,
                             self.pricelist_1.get_product_price(self.product_2, 1, self.partner_1, '2021-08-18'),
                             'to_product_pricelist_weekdays: Pricelist not working')
