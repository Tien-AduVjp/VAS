{
    ...
    'name_vi_VN': "Quản lý Tài liệu Tuyển dụng",
...
What it does
============
This bridge module between Document Management System and Recruitment.
...
Mô tả
=====
Mô đun cầu nối giữa Quản lý tài liệu và Tuyển dụng.
...
2. Ấn bản Enterprise
    ...
    'version': '0.1.0',
    'depends': ['viin_document_hr','hr_recruitment'],
    'data': [
