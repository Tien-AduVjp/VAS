...
class HrRole(models.Model):
    ...
    employee_ids = fields.One2many('hr.employee', 'role_id', string='Employees', help="All the employees that are currently set at this role.")
    ...
    def action_view_employees(self):
        if self.env.user.has_group('hr.group_hr_user'):
            ...
            action = self.env.ref('hr.hr_employee_public_action')
