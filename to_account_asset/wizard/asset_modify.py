...
class AssetModify(models.TransientModel):
    ...
    asset_method_time = fields.Char(compute='_compute_asset_method_time', string='Asset Method Time', readonly=True)
    ...
    def _compute_asset_method_time(self):
        ...
        for r in self:
            if asset_id:
                ...
                r.asset_method_time = asset.method_time
            else:
                r.asset_method_time = False
