{
    ...
    'depends': ['to_enterprise_marks_account'],
    'description': """
What it does
============
...
* Allow to create Asset Categories and configure rules for each type (depreciation method, time method, number of entries, journal entries, etc.)
...
* Cho phép tạo các Nhóm tài sản và cấu hình sẵn quy tắc cho từng kiểu (phương pháp tính toán, số lần khấu hao, ngày khấu hao,
  bút toán sổ nhật ký,...)
...
2. Ấn bản Enterprise
    ...
    'data': [
        ...
        'wizard/asset_fill_missing_values_wizard.xml',
