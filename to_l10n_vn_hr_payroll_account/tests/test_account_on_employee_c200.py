...
class TestAccountOnEmployee200(TestCommonC200):
    ...
    def test_01_account_on_employee(self):
        ...
        self.assertEqual(employee1.address_home_id.with_company(self.company_c200).property_account_payable_id.id, self.account_334_id)
