...
class AccountPayment(models.Model):
    ...
    @api.onchange('sale_order_ids', 'currency_id', 'date')
    ...
    def _onchange_partner_id_so(self):
        if self.sale_order_ids and self.partner_id not in self.sale_order_ids.partner_invoice_id:
    ...
    def _message_track_sale_order_ids(self, old_vals, new_vals):
        for r in self:
            ...
            if old_sale_orders != new_sale_orders:
