...
class Common(Common):
    ...
    def setUpClass(cls):
        ...
        accounts_vn = cls.env['account.account'].search([('company_id','=',company_data_vn['company'].id)])
        cls.default_account_1111_01 = accounts_vn.filtered(lambda r:r.code == '1111-01')
        cls.default_account_1111_02 = accounts_vn.filtered(lambda r:r.code == '1111-02')
        cls.default_account_1125_01 = accounts_vn.filtered(lambda r:r.code == '1125-01')
        cls.default_account_1125_02 = accounts_vn.filtered(lambda r:r.code == '1125-02')
        ...
        cls.analytic_tag_short_term_prepaid_expense = cls.env.ref('l10n_vn_common.account_analytic_tag_short_term_prepaid_expense')
        cls.analytic_tag_long_term_prepaid_expense = cls.env.ref('l10n_vn_common.account_analytic_tag_long_term_prepaid_expense')
        cls.analytic_tag_fixed_assets = cls.env.ref('l10n_vn_common.account_analytic_tag_fixed_assets')
        cls.analytic_tag_interests_dividends_distributed_profits = cls.env.ref('l10n_vn_common.account_analytic_tag_interests_dividends_distributed_profits')
        cls.analytic_tag_borrowing_loan = cls.env.ref('l10n_vn_common.account_analytic_tag_borrowing_loan')
        cls.analytic_tag_lending_loan = cls.env.ref('l10n_vn_common.account_analytic_tag_lending_loan')
