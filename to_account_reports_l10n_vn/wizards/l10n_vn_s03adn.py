...
class WizardL10n_vn_s03adn(models.TransientModel):
    ...
    def _print_report(self, data):
        res = self.env.ref('to_account_reports_l10n_vn.report_l10n_vn_s03adn_action').report_action(self, data=data)
        return res
    ...
    def check_report_excel(self):
        ...
        return {
            ...
            'url': '/general-ledger/download/xlsx/%d' % self.id,
            'target': '_blank'
        }
    ...
    def _prepare_check_report(self):
        ...
        # Get line
        lines = self.env['report.to_account_reports_l10n_vn.report_s03adn']._get_lines(data)
        dict_data = {
            'data': data,
            'lines': lines,
            'account_ids': False,
    ...
    def _build_contexts(self, data):
        self.ensure_one()
        result = super(WizardL10n_vn_s03adn, self)._build_contexts(data)
