...
class TestOvertimeApprovalPayroll(CommonOverTimeApproval):
    ...
    def test_01_overtime_approval_payroll(self):
        ...
        - Input:
            + Tạo phiếu lương cho employee1, với kế hoạch tăng ca không tham chiếu tới đề nghị phê duyệt tăng ca nào
    ...
    def test_02_overtime_approval_payroll(self):
        ...
        - Input:
            + Tạo phiếu lương cho employee1, với kế hoạch tăng ca được tham chiếu tới đề nghị phê duyệt tăng ca, ở trạng thái Dự thảo
            + Thời gian kế hoạch hợp lệ với phiếu lương
    ...
    def test_03_overtime_approval_payroll(self):
        ...
        - Input:
            + Tạo phiếu lương cho employee1, với kế hoạch tăng ca được tham chiếu tới đề nghị phê duyệt tăng ca, ở trạng thái Xác nhận
            + Thời gian kế hoạch hợp lệ với phiếu lương
        - Output: Tạo thành công phiếu lương, kế hoạch tăng ca không hợp lệ, không được nhận diện vào phiếu lương
        """
    ...
    def test_05_overtime_approval_payroll(self):
        ...
        - Input:
            + Tạo phiếu lương cho employee1, với kế hoạch tăng ca được tham chiếu tới đề nghị phê duyệt tăng ca, ở trạng thái Đã huỷ
            + Thời gian kế hoạch hợp lệ với phiếu lương
        - Output: Tạo thành công phiếu lương, kế hoạch tăng ca không hợp lệ, không được nhận diện vào phiếu lương
        """
    ...
    def test_06_overtime_approval_payroll(self):
        ...
        - Input:
            + Tạo phiếu lương cho employee1, với kế hoạch tăng ca được tham chiếu tới đề nghị phê duyệt tăng ca, ở trạng thái Đã phê duyệt
            + Thời gian kế hoạch hợp lệ với phiếu lương
        - Output: Tạo thành công phiếu lương, kế hoạch tăng ca hợp lệ được nhận diện vào phiếu lương
        """
    ...
    def test_07_overtime_approval_payroll(self):
        ...
        - Input:
            + Tạo phiếu lương cho employee1, với kế hoạch tăng ca được tham chiếu tới đề nghị phê duyệt tăng ca, ở trạng thái Đã hoàn thành
            + Thời gian kế hoạch hợp lệ với phiếu lương
        - Output: Tạo thành công phiếu lương, kế hoạch tăng ca hợp lệ được nhận diện vào phiếu lương
        """
    ...
    def test_08_overtime_approval_payroll(self):
        ...
        - Input:
            + Phiếu lương employee1 ở trạng thái dự thảo và có dòng tăng ca được tham chiếu tới đề nghị phê duyệt
    ...
    def test_09_overtime_approval_payroll(self):
        ...
        - Input:
            + Phiếu lương employee1 không ở trạng thái Dự thảo và có dòng tăng ca được tham chiếu tới đề nghị phê duyệt
            đang ở trạng thái Đã phê duyệt/Hoàn Thành
            + Thực hiện từ chối kế hoạch tăng ca
        - Output:
