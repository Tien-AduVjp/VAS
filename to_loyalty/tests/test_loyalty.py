...
class TestLoyalty(LoyaltyCommon):
    ...
    def test_06_loyalty_points_of_customer(self):
        self.partner_1.loyalty_points = 15
        self.assertEqual(self.partner_1.loyalty_points, 15, "to_loyalty: Wrong points of parnter_1")
        self.assertEqual(self.partner_1.level_id.id, self.customer_level_1.id, "to_loyalty: Wrong level of parnter_1")
        self.assertEqual(self.customer_level_1.partner_ids_count, 2, "to_loyalty: Wrong count partnet on customer level")
