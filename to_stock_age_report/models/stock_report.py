...
class AccountReport(models.AbstractModel):
    ...
    def get_report_informations(self, options):
        ...
        info = {'options': options,
                ...
                'searchview_html': self.env['ir.ui.view'].render_template(self.get_templates().get('search_template', 'to_stock_age_report.search_template'), values=searchview_dict),
                }
        return info
