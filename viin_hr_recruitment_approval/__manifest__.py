{
    'name': "Recruitment Requests/Approvals",
    'old_technical_name': 'to_hr_recruitment_request',
...
2. Ấn bản Enterprise
    ...
    'depends': ['hr_recruitment', 'hr_contract', 'to_hr_skills_recruitment', 'to_approvals'],

    # always loaded
    'data': [
             # 'data/module_data.xml',
             'security/recruitment_approval_security.xml',
