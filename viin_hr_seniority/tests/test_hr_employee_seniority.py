...
class TestHrEmployeeSeniority(TransactionCase):
    ...
    def test_hr_employee_seniority_1(self):
        ...
        self.assertEqual(self.employee.first_contract_date, date_start)
        ...
        self.assertEqual(contract.years, 1.0)
        self.assertEqual(contract.months, 12.0)
        self.assertEqual(self.employee.first_contract_date, contract.date_start)
    ...
    def test_hr_employee_seniority_5(self):
        ...
        self.assertEqual(self.employee.first_contract_date, date(2020, 6, 15))
