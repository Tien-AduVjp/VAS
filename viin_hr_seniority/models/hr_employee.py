...
class HrEmployee(models.Model):
    ...
    # override the first_contract_date to make it stored
    first_contract_date = fields.Date(store=True, tracking=True,
    ...
    def action_view_employee_seniority(self):
        action = self.env['ir.actions.act_window']._for_xml_id('viin_hr_seniority.action_hr_employee_seniority_report')
        action.update({
