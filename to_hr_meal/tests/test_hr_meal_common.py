...
class TestHrMealCommon(SavepointCase):
    ...
    def setUpClass(cls):
        ...
        user_group_hr_meal_user = cls.env.ref('to_hr_meal.group_hr_meal_user')
        user_group_hr_meal_manager = cls.env.ref('to_hr_meal.group_hr_meal_manager')
    ...
    def create_meal_order(self, meal_type, order_source, employees):
        ...
        meal_order_form.meal_type_id = meal_type
