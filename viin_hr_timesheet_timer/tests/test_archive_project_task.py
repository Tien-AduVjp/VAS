...
class TestArchiveProjectTask(Common):
    ...
    def test_01_log_timesheet_on_archived_task(self):
        ...
        """
        self.office_design_task1.action_archive()

        with self.assertRaises(UserError):
            self.office_design_task1.action_start()
    ...
    def test_02_log_timesheet_not_allow_archive_task(self):
        ...
        """
        self.office_design_task1.with_user(self.user_admin).action_start()

        with self.assertRaises(UserError):
            self.office_design_task1.with_user(self.user_admin).action_archive()
    ...
    def test_03_log_multi_timesheet_ignore_archived_task(self):
        ...
        """
        # Archive task 2
        self.office_design_task2.with_user(self.user_admin).action_archive()
        ...
        self.env['account.analytic.line'].with_user(self.user_admin).create({
            'project_id': self.office_design_task2.project_id.id,
            'task_id': self.office_design_task2.id,
