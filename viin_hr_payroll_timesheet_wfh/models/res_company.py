...
class ResCompany(models.Model):
    ...
    def _prepare_pow_timesheet_salary_rule_vals(self, struct):
        ...
        return {
            ...
            'condition_python': """result = not payslip.thirteen_month_pay and True if hasattr(employee, 'pow_timesheet_required') and employee.pow_timesheet_required else False""",
            'amount_select': 'code',
