...
class TestPayment(AccountingTestCase):
    ...
    def setUp(self):
        ...
        self.rate_eur = self.env['res.currency.rate'].create({
            'rate': 1.000000,
        ...
        self.rate_vnd = self.env['res.currency.rate'].create({
            'rate': 26330.010000,
        ...
        self.default_payment_acquirer = self.env.ref('payment.payment_acquirer_transfer')
        ...
        # Check  created journal and its default account 
        self.currency_conversion_diff_journal = self.env.company.currency_conversion_diff_journal_id
        self.currency_conversion_diff_journal.default_debit_account_id = self.env.ref('l10n_generic_coa.1_cash_diff_expense')
        self.currency_conversion_diff_journal.default_credit_account_id = self.env.ref('l10n_generic_coa.1_cash_diff_income')
    ...
    def test_payment_transaction_01(self):
        ...
        diff_move_line = payment.move_line_ids.filtered(lambda ml: ml.journal_id  == self.currency_conversion_diff_journal)
    ...
    def test_payment_transaction_02(self):
        ...
        income_move_line = diff_move_line.move_id.line_ids.filtered(lambda ml: ml.account_id == self.env.ref('l10n_generic_coa.1_cash_diff_income'))
