...
class TestHRLeave(TestPayrollCommon):
    ...
    def test_00_leave(self):
        ...
        date_from = fields.Datetime.to_datetime('2021-07-07 06:00:00')
        date_to = fields.Datetime.to_datetime('2021-07-09 20:00:00')
        ...
        try:
            ...
            self.fail("The time-off %s should be able to get refused." % hol1.display_name)

    def test_01_leave(self):
        """
        Case 1: Test Hủy các xin nghỉ của nhân viên, thời gian xin nghỉ của nhân viên trùng khoảng thời gian của phiếu lương của nhân viên
            Output: Từ chối không thành công, thông báo ngoại lệ
        """
        ...
        # cannot refuse a time of linked to a verified payslip
        with self.assertRaises(UserError):
            hol1.action_refuse()

    def test_02_leave(self):
        """
        Case 1: Test Hủy các xin nghỉ của nhân viên, thời gian xin nghỉ của nhân viên trùng khoảng thời gian của phiếu lương của nhân viên
            Output: Từ chối không thành công, thông báo ngoại lệ
        """
        ...
        hol1.action_confirm()
        hol1.action_validate()
        # set payslip to draft and vefify it
