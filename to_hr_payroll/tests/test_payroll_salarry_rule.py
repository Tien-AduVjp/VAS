...
class TestPayrollSalaryRule(TestPayrollCommon):
    ...
    def test_form_salary_rule_category(self):
        """
        Tạo 1 nhóm quy tắc lương mới (A)

        Trường Cấp cha chọn 1 nhóm quy tắc lương (B) có đánh dấu thanh toán bởi công ty
            => Nhóm quy tắc lương (A) có đánh dấu thanh toán bởi công ty

        Trường Cấp cha chọn 1 nhóm quy tắc lương (C) không đánh dấu thanh toán bởi công ty
            => Nhóm quy tắc lương (A) không đánh dấu thanh toán bởi công ty
        """
