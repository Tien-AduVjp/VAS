odoo.define('viin_account_reconciliation.ReconciliationClientAction', function(require) {
    "use strict";

    var AbstractAction = require('web.AbstractAction');
    var ReconciliationModel = require('viin_account_reconciliation.ReconciliationModel');
    var ReconciliationRenderer = require('viin_account_reconciliation.ReconciliationRenderer');
    ...
    var StatementAction = AbstractAction.extend({
        ...
        custom_events: {
            ...
            reload: 'reload',
            // search: '_onSearch', // removed in Odoo 14
        ...
        init: function(parent, params) {
            ...
            this.params = params;
            // controlPanelParams is now searchModelConfig in Odoo 14
        ...
        /**
         * @private
         * @param {Object} searchQuery // its was OdooEvent in Odoo 13
         */
