...
class AccountBankStatementLine(models.Model):
    ...
    # TODO: check if this field is really necessary now since Odoo 14
    ...
    def process_reconciliation(self, counterpart_aml_dicts=None, payment_aml_rec=None, new_aml_dicts=None):
        ...
        # TODO: find a new way to recognize if the line is linked to a suspended move
        ...
        for aml_rec in payment_aml_rec:
            ...
            if aml_rec.journal_id.post_at == 'bank_rec' and aml_rec.payment_id and aml_rec.move_id.state == 'draft':
                ...
                aml_rec.move_id._post(soft=False)
                ...
                for invoice in aml_rec.payment_id.reconciled_invoice_ids:
                    invoice._recompute_invoice_amounts()
        ...
        if counterpart_aml_dicts or new_aml_dicts:
            ...
            if self.move_id.state != 'posted':
                self.move_id.with_context(skip_account_move_synchronization=True)._post(soft=False)

            # Reconcile new lines with counterpart
            for new_aml, counterpart_move_line in aml_to_reconcile:
                (new_aml | counterpart_move_line).reconcile()
                counterpart_move_line.move_id._recompute_invoice_amounts()
