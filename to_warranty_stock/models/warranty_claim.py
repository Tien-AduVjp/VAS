    ...
    def _onchange_lot_and_type(self):
        ...
        if self.lot_id:
            ...
            for warranty_claim_policy_id in warranty_claim_policy_ids:
                warranty_claim_policies += warranty_claim_policies.new(warranty_claim_policy_id._prepare_warranty_claim_policy_on_lot_data())
            self.warranty_claim_policy_ids = warranty_claim_policies
        return res
