...
class ProductionLot(models.Model):
    ...
    warranty_period = fields.Integer('Warranty period (months)', compute='_get_warranty_period', inverse='_set_warranty_period',
    ...
    def action_view_warranty_history(self):
        ...
        action = self.env.ref('to_warranty_stock.action_warranty_claim_history').read()[0]
