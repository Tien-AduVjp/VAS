...
class TestHrOvertimeRequestMass(Common):
    ...
    def test_02_compute_employee_ids(self):
        """
            Case: Test compute employees when selected mode is "employee" and user make plan is not in team approval group.
            Expect: show current user only.
        """
        ...
        self.assertEqual(self.ot_request_mass.employee_ids, self.user_01.employee_id)        
