...
class TestBlockQuantity(TestStockCommon):
    ...
    def test_not_allow_process_exceeded_demand_quantity(self):
        ...
        self.picking_pick.move_lines[0].quantity_done = 11
    ...
    def test_allow_process_exceeded_demand_quantity(self):
        ...
        self.assertEqual(self.picking_client.move_lines[0].quantity_done, self.picking_client.move_lines[0].product_uom_qty, 'Quanitiy_done not ok')
    
    @classmethod
    def create_pick_ship(cls):
        picking_client = cls.env['stock.picking'].create({
        ...
        picking_pick = cls.env['stock.picking'].create({
