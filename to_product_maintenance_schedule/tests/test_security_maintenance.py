...
class TestMaintenanceSecurity(MaintenanceScheduleCommon):
    ...
    def test_02_group_equipment_manager(self):
        ...
        self._check_only_read_action_schedule()
    ...
    def test_05_group_maintenance_manager(self):
        """ test case 4
            ...
            user_2 can't setting
            user_2 can read, create, write, unlink action, schedule"""
        self.user_2.write({'groups_id': [(6, 0, [self.group_maintenance_manager.id])]})
    ...
    def test_06_group_maintenance_manager_group_equipment_manager(self):
        """ test case 4
            user_2 has group group_equipment_manager, group_maintenance_manager
            user_2 can read, create, write, unlink all document
            user_2 can setting
            user_2 can read, create, write, unlink action, schedule"""
        self.user_2.write({'groups_id': [(6, 0, [self.group_maintenance_manager.id, self.group_equipment_manager.id])]})
        self._check_full_permission()
        self._check_full_permission_action_schedule()
