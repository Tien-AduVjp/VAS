...
class TestProductionLot(TestBase):
    ...
    def test_after_install_module_01(self):
        ...
        """
        new_paper_format = self.env.ref('viin_repair.to_repair_report_landscape')
    ...
    def test_render_report_01(self):
        ...
        pdf = self.env.ref('viin_repair.to_report_repair')._render_qweb_pdf(selected_repair_orders.ids)
