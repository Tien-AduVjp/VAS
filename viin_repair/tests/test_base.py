...
class TestBase(SavepointCase):
    ...
    def setUpClass(cls):
        ...
        cls.env['stock.quant']._update_available_quantity(cls.product_to_repair1, cls.env.ref('stock.stock_location_stock'), 1)
        cls.env['stock.quant']._update_available_quantity(cls.product_to_repair1, cls.env.ref('stock.stock_location_stock'), 1, lot_id=cls.lot1)
