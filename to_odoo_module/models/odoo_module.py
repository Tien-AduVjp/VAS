...
class OdooModule(models.Model):
    ...
    def _compute_odoo_module_version_id(self):
        for r in self:
            r.odoo_module_version_id = r.odoo_module_version_ids._sorted_by_full_version_str(reverse=True)[:1] or False
    ...
    def get_latest_version(self):
        ...
        """
        return self.odoo_module_version_ids._sorted_by_full_version_str(reverse=True)[:1]
