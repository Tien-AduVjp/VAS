...
class GitRepository(models.Model):
    ...
    def action_view_odoo_modules(self):
        ...
        result = self.env["ir.actions.act_window"]._for_xml_id('to_odoo_module.odoo_module_action')
    ...
    def action_view_app_product_templates(self):
        ...
        result = self.env['ir.actions.act_window']._for_xml_id('product.product_template_action')
