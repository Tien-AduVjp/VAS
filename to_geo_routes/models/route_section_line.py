...
class RouteSectionLine(models.Model):
    ...
    distance_in_miles = fields.Float(string='Distance (mi.)', help='The distance in miles between the From and To', related='section_id.distance_in_miles', store=True, default=0.0)
