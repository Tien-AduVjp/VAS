...
class TestEmployeeAdvanceForm(Common): 
    ...
    def test_21_validate_reconcile_batches(self):
        ...
        self.assertFalse(emd_reconcile_batch_1.employee_ids)
        ...
        self.assertIn(self.employee_advance_manager_employee, emd_reconcile_batch_2.employee_ids)
        ...
        self.assertFalse(emd_reconcile_batch_2.employee_ids)
