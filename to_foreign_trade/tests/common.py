...
class TestCommon(SavepointCase):
    ...
    def setUpClass(cls):
        ...
        cls.foreign_trade_user = Users.create({
            ...
            'groups_id': [(6, 0, [cls.env.ref('to_foreign_trade.group_foreign_trade_user').id])],
        ...
        cls.foreign_trade_manager = Users.create({
            ...
            'groups_id': [(6, 0, [cls.env.ref('to_foreign_trade.group_foreign_trade_manager').id])],
            'company_ids': [(6, 0, [cls.env.ref('base.main_company').id])],
            'company_id': cls.env.ref('base.main_company').id
        })
        ...
        cls.foreign_trade_partner = cls.env['res.partner'].create({
            ...
            'property_stock_customer': cls.env.ref('to_foreign_trade.to_stock_location_customers_export')
        })
