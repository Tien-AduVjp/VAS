...
class ForeignTradeConfiguration(models.TransientModel):
    _inherit = 'res.config.settings'

    import_tax_payment_term = fields.Many2one('account.payment.term',
                                              string='Default Import Tax Payment Term',
                                              related='company_id.import_tax_payment_term', readonly=False,
    ...
    export_tax_payment_term = fields.Many2one('account.payment.term',
                                              ...
                                              related='company_id.export_tax_payment_term', readonly=False,
