...
#     _order = 'sequence'
    ...
    def _prepare_account_move_lines(self):
        ...
        if self.is_vat:
            ...
            debit_account = self.product_id.categ_id.property_stock_valuation_account_id
            if not debit_account:
                raise ValidationError(_("Cannot find stock valuation account specify for the product category '%s'.")
