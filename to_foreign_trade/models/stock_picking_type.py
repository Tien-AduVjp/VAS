...
class stock_picking_type(models.Model):
    ...
    def _update_location(self, warehouse, new_reception_step=False, new_delivery_step=False):
        ...
        import_in_id = self.env['ir.model.data'].xmlid_to_res_id('to_foreign_trade.to_stock_picking_type_import_in', raise_if_not_found=False)
        ...
        export_in_id = self.env['ir.model.data'].xmlid_to_res_id('to_foreign_trade.to_stock_picking_type_export_out', raise_if_not_found=False)
