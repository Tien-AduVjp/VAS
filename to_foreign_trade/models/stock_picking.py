...
class stock_picking(models.Model):
    ...
    custom_declaration_import_ids = fields.One2many('custom.declaration.import', 'stock_picking_id',
    ...
    custom_declaration_export_ids = fields.One2many('custom.declaration.export', 'stock_picking_id',
                                                    groups='to_foreign_trade.group_foreign_trade_user,stock.group_stock_user',
    ...
    custom_dec_import_count = fields.Integer(string="# of Custom Clearance Import Request",
                                             groups='to_foreign_trade.group_foreign_trade_user,stock.group_stock_user',
                                             compute='_compute_custom_dec_import_count')
    custom_dec_export_count = fields.Integer(string="# of Custom Clearance Export Request",
                                             groups='to_foreign_trade.group_foreign_trade_user,stock.group_stock_user',
                                             compute='_compute_custom_dec_export_count')
