			...
			this.data = {
				lead: {
					fields: {
						...
						activity_exception_icon: {sring:'Activity Exception Icon',  type:'char'},
						...
						opportunities: {string: 'opportunities', type:'float', default: 10},
						expected_revenue_aggregate: {string: 'expected revenue aggregate', type:'float', default: 10},
						prorated_revenue_aggregate: {string: 'prorated revenue aggregate', type:'float', default: 10},
						prorated_revenue: {string: 'prorated revenue', type:'float', default: 10},
						deal_size: {string: 'deal size', type:'float', default: 10},
						days_to_assign: {string: 'days to assign', type:'float', default: 10},
						days_to_close: {string: 'days to close', type:'float', default: 10},
						days_exceeding_closing: {string: 'days exceeding closing', type:'float', default: 10},
					},
					records: [
						{
							"id": 25,
