odoo.define('viin_web_dashboard.test_utils', function(require) {
	"use strict";
	...
	var testUtilsCreate = require('viin_web_dashboard.test_utils_create');
	var testUtils = require('web.test_utils');

	testUtils.createViinDashboardView = testUtilsCreate.createViinDashboardView;
	return testUtils;
