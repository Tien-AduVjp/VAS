...
@view_validation.validate('viin_dashboard')
def schema_dashboard(arch, **kwargs):
    """ Check the viin_dashboard view against its schema
    ...
    if _dashboard_validator is None:
        with misc.file_open(os.path.join('viin_web_dashboard', 'views', 'viin_dashboard.rng')) as f:
