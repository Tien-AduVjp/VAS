{
    ...
    'name_vi_VN': "Quản lý Tài liệu Dự án",
...
What it does
============
This bridge module between Document Management System and Project.
...
Mô tả
=====
Mô đun cầu nối giữa Quản lý tài liệu và Dự án.
...
2. Ấn bản Enterprise
    ...
    'demo': [
        'demo/document_tag_data.xml',
        'demo/document_team_data.xml',
