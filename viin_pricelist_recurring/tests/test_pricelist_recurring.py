...
class PricelistRecurring(TransactionCase):
    ...
    def test_1001_get_product_price_monthly(self):
        ...
        self.assertEqual(5000000,
                         self.pricelist_1.get_product_price(self.product_1, 1, self.partner_1, '2021-08-11'),
                         'viin_pricelist_recurring: Pricelist not working')
        self.assertEqual(5000000,
                         self.pricelist_1.get_product_price(self.product_1, 1, self.partner_1, '2021-09-01'),
                         'viin_pricelist_recurring: Pricelist not working')
        self.assertEqual(10000000,
                         self.pricelist_1.get_product_price(self.product_1, 1, self.partner_1, '2021-08-16'),
                         'viin_pricelist_recurring: Pricelist not working')
        self.assertEqual(20000000,
                         self.pricelist_1.get_product_price(self.product_2, 1, self.partner_1, '2021-08-11'),
                         'viin_pricelist_recurring: Pricelist not working')
    ...
    def test_1002_get_product_price_annually(self):
        ...
        self.assertEqual(10000000,
                         self.pricelist_1.get_product_price(self.product_1, 1, self.partner_1, '2023-08-18'),
                         'viin_pricelist_recurring: Pricelist not working')
        self.assertEqual(6000000,
                         self.pricelist_1.get_product_price(self.product_1, 1, self.partner_1, '2023-01-02'),
                         'viin_pricelist_recurring: Pricelist not working')
        self.assertEqual(20000000,
                         self.pricelist_1.get_product_price(self.product_2, 1, self.partner_1, '2023-01-02'),
                         'viin_pricelist_recurring: Pricelist not working')
