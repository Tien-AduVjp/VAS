{
    'name': "Documents - HR",
    'name_vi_VN': "Quản lý Tài liệu Nhân sự",
...
What it does
============
This bridge module between Document Management System and HR.
...
Mô tả
=====
Mô đun cầu nối giữa Quản lý tài liệu và Nhân sự.
