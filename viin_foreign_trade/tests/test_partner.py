...
class TestPartner(TestCommon):
    ...
    def test_create_partner_01(self):
        ...
        with Form(self.env['res.partner']) as f:
            ...
            self.assertEqual(f.property_stock_customer, self.env.ref('viin_foreign_trade.to_stock_location_customers_export'))
    ...
    def test_create_partner_07(self):
        ...
        self.assertEqual(new_partner.property_stock_customer, self.env.ref('viin_foreign_trade.to_stock_location_customers_export'))
