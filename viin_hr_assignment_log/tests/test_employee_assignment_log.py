...
class TestEmployeeAssignmentLogIrcron(TestUserAssignmentLogCommon):
    ...
    def setUp(self):
        ...
        self.employee_user_main_comp.with_context(force_company=self.employee_user_main_comp.company_id.id).action_create_employee()
        self.employee_user_comp_B.with_context(force_company=self.employee_user_comp_B.company_id.id).action_create_employee()
