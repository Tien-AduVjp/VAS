...
class AccountPaymentTermLine(models.Model):
    ...
    option = fields.Selection(selection_add=[
        ...
        ], ondelete={'fix_day_next_x_months': 'set default', 'last_day_next_x_months': 'set default'})
    number_of_next_month = fields.Integer(string='Number of next month')

    @api.constrains('day_of_the_month', 'number_of_next_month')
    ...
    def _onchange_option(self):
        if self.option == 'last_day_next_x_months':
            ...
            return super(AccountPaymentTermLine, self)._onchange_option()
        ...
        for line in self.line_ids:
            ...
            if amt:
                ...
                if line.option == 'fix_day_next_x_months':
                    next_date += relativedelta(day=line.day_of_the_month, months=line.number_of_next_month)
