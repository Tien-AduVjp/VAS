...
class WizardL10n_vnc200_s07dn(models.TransientModel):
    _name = 'wizard.l10n_vn.c200.s07dn'
    _inherit = 'account.common.report'
    _description = 'VietNam C200 S07dn Report Winzard'
    ...
    def _build_contexts(self, data):
        result = super(WizardL10n_vnc200_s07dn, self)._build_contexts(data)
        result['account_ids'] = data['form'].get('account_ids', False)
        return result

    def _print_report(self, data):
        res = self.env.ref('viin_l10n_vn_account_cash_book.act_report_c200_s07dn').report_action(self, data=data)
        return res
    ...
    def _data_report_excel(self, data):
        ...
        lines = self.env['report.viin_l10n_vn_account_cash_book.report_c200_s07dn']._get_lines(data)
