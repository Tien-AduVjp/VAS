...
class TestUnbuildPurchasedBomKit(SavepointCase):
    ...
    def setUpClass(cls):
        ...
        cls.pothos_office = cls.env.ref('mrp.product_product_computer_desk')
        cls.pothos_plant_without_pot = cls.env.ref('mrp.product_product_computer_desk_head')
        cls.big_plant_pot = cls.env.ref('mrp.product_product_computer_desk_leg')
        cls.soil_for_plant = cls.env.ref('stock.product_cable_management_box')
