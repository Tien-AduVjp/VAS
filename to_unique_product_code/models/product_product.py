    ...
    def _check_default_code(self):
        ...
        for r in records_to_check:
            if r.same_default_code_product_id:
                raise ValidationError(_("Invalid Internal Reference! The Internal Reference '%s' has been assigned to the product '%s'."
                                        " Please input another Internal Reference!")
