...
class AccountChartTemplate(models.Model):
    ...
    def _prepare_all_journals(self, acc_template_ref, company, journals_dict=None):
        ...
        borrowing_loan_journal_data.update({
            'default_account_id': acc_template_ref.get(self.property_borrowing_account_id.id),
            })
        ...
        lending_loan_journal_data.update({
            'default_account_id': acc_template_ref.get(self.property_lending_account_id.id),
            })
