...
#     _inherit = 'account.abstract.payment'
    ...
    # TODO: restrict showing appropriate records for payment_method_id
    ...
    def _onchange_journal(self):
        if self.journal_id:
            self.currency_id = self.journal_id.currency_id or self.company_id.currency_id or self.env.company.currency_id
    ...
    def _prepare_acc_move_lines_data(self):
        ...
        line2 = {
            ...
            'account_id': self.journal_id.payment_debit_account_id.id if possitive_amount else self.journal_id.payment_credit_account_id.id,
            'currency_id': diff_currency and self.currency_id.id,
            'ref': self.communication,
        }
        if diff_currency:
