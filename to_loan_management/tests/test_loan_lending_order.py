...
class TestLoanLendingOrder(TestLoanCommon):
    ...
    def setUpClass(cls, company=None):
        ...
        cls.loan_order_month_flat = cls.create_loan_order_form(100000000, cls.interest_flat_rate_type_month)
        cls.loan_order_week_flat = cls.create_loan_order_form(100000000, cls.interest_flat_rate_type_week)
        cls.loan_order_year_flat = cls.create_loan_order_form(100000000, cls.interest_flat_rate_type_year)
    ...
    def create_loan_order_form(cls, loan_amount, interest_rate_type, loan_duration=None):
        loan_order_form = Form(cls.env['loan.lending.order'])
    ...
    def create_disburement(self, loan_order, amount, custom_value=None):
        ...
        return self.env['loan.lend.disbursement'].create(value)
    ...
    def create_payment(self, amount, invoice):
        payment_type = 'outbound' if invoice.type == 'in_invoice' else 'inbound'
        partner_type = 'supplier' if invoice.type == 'in_invoice' else 'customer'
        vals = {
            'amount': amount,
    ...
    def test_loan_order_form(self):
        ...
        self.assertRecordValues(loan_order,
                                [{'product_id': self.interest_flat_rate_type_month.product_id.id,
                                  'journal_id': self.journal_loan_lend.id,
                                  'account_id': self.account_loan_lend.id}]
                                )
    ...
    def test_interest_flat_rate_01(self):
        """
    ...
    def test_interest_flat_rate_02(self):
        """
    ...
    def test_interest_flat_rate_03(self):
        """
    ...
    def test_interest_flat_rate_04(self):
        """
        Interest Rate Type: month
    ...
    def test_interest_flat_rate_05(self):
        """
        Interest Rate Type: year
        Interest Cycle: year
        """
    ...
    def test_interest_flat_rate_08(self):
        """
        Interest Rate Type: month
        Interest Cycle: month
    ...
    def test_interest_flat_rate_09(self):
        """
        Interest Rate Type: year
        Interest Cycle: year
        Fixed Days of Month: 28
    ...
    def test_interest_flat_rate_10(self):
        """
        Interest Rate Type: week
        Interest Cycle: week
    ...
    def test_interest_flat_rate_11(self):
        """
        Interest Rate Type: month
        Interest Cycle: month
        Fixed Days of Year: 360
    ...
    def test_interest_flat_rate_12(self):
        """
        Interest Rate Type: year
        Interest Cycle: year
        Fixed Days of Year: 360
    ...
    def test_interest_flat_rate_13(self):
        """
        Interest Rate Type: year
        Interest Cycle: year
        Fixed Days of Year: 360
    ...
    def test_interest_flat_rate_14(self):
        """
        Interest Rate Type: year
        Interest Cycle: year
    ...
    def test_interest_flat_rate_16(self):
        """
        Interest Rate Type: month
        Interest Cycle: month
        Fixed Days of Year: 360
    ...
    def test_interest_flat_rate_18(self):
        """
        Interest Rate Type: year
        Interest Cycle: month
        """
    ...
    def test_interest_flat_rate_19(self):
        """
        Interest Rate Type: year
        Interest Cycle: year
        Refund Numbers: 2
    ...
    def test_interest_flat_rate_20(self):
        """
        Interest Rate Type: year
        Interest Cycle: year
        Refund Numbers: 2
    ...
    def test_interest_flat_rate_21(self):
        """
    ...
    def test_disbursement_register(self):
        ...
        self.assertRecordValues(loan_order.disbursement_line_ids.move_ids[0].line_ids, [
            {'date': date(2021, 10, 15), 'debit': 50000000,
             'credit': 0, 'account_id': self.account_loan_lend.id},
            {'date': date(2021, 10, 15), 'debit': 0,
             'credit': 50000000, 'account_id': self.journal_bank.default_debit_account_id.id},
        ])
    ...
    def test_disbursement_register_2(self):
        ...
        self.assertRecordValues(loan_order.disbursement_line_ids.move_ids.line_ids, [
            ...
            {'date': date(2021, 10, 15), 'debit': 50000000,
             'credit': 0, 'account_id': self.account_loan_lend.id},
            {'date': date(2021, 10, 15), 'debit': 0,
             'credit': 100000000, 'account_id': self.journal_bank.default_debit_account_id.id},
        ])
    ...
    def test_set_days_of_month_or_year_to_zero(self):
        with self.assertRaises(UserError):
            self.interest_flat_rate_type_month.write({
                'fixed_days_of_year': True,
                'days_of_year': 0,
                'fixed_days_of_month': True,
                'days_of_month': 0
