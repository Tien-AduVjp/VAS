...
class HrContract(models.Model):
    ...
    def _get_accounts(self):
        ...
        self = self.sudo()
        return {
            'expense_account': self.account_expense_id or self.department_id.account_expense_id,
            'analytic_account': self.analytic_account_id or self.department_id.analytic_account_id,
            'analytic_tags': self.analytic_tag_ids or self.department_id.analytic_tag_ids,
            }
