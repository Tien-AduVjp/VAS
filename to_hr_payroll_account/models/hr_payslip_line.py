...
class HrPayslipLine(models.Model):
    ...
    def _get_accounts(self):
        ...
        self = self.sudo()
        contract_accounts = self.contract_id._get_accounts()
        return {
            'debit_account': self.salary_rule_id.account_debit or contract_accounts['expense_account'] if self.salary_rule_id.generate_account_move_line else self.env['account.account'],
            'credit_account': self.salary_rule_id.account_credit if self.salary_rule_id.generate_account_move_line else self.env['account.account'],
            'analytic_account': self.salary_rule_id.analytic_account_id or contract_accounts['analytic_account'] if self.salary_rule_id.generate_account_move_line and self.salary_rule_id.anylytic_option != 'none' else self.env['account.analytic.account'],
            'analytic_tags': self.salary_rule_id.analytic_tag_ids or contract_accounts['analytic_tags'] if self.salary_rule_id.generate_account_move_line and self.salary_rule_id.anylytic_option != 'none' else self.env['account.analytic.tag'],
            }
