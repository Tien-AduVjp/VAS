...
class TestHrContract(TestPayrollCommon):
    ...
    def test_03_vn_contract(self):
        ...
        Input: Truy cập hợp đồng nhân viên quốc gia Việt Nam, Chưa có quy tắc thuế Việt Nam nào
        Output:
        ...
        self.env['personal.tax.rule'].search([('country_id', '=', country_vn_id)]).unlink()
