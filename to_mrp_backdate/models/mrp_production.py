...
class MrpProduction(models.Model):
    ...
    def post_inventory(self):
        ...
        if ctx.get('open_mrp_inventory_backdate_wizard', False)\
            and not ctx.get('manual_validate_date_time')\
            and self.env.user.has_group('to_backdate.group_backdate') and not len(self) > 1:
