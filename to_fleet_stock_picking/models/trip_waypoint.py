...
class FleetVehicleTripWaypoint(models.Model):
    ...
    total_weight = fields.Float(string="Total Weight", compute='_compute_total_load', store=True,
                                help='Total Weight in Kg of all the pickings that will be picked or delivered at this trip waypoint.')
    total_stowage_volume = fields.Float(string="Total Stowage Volume", store=True,
