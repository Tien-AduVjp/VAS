...
class WarrantyClaim(models.Model):
    ...
    def _compute_warranty_claim_policy_ids(self):
        ...
        for r in self:
            ...
            if r.type == 'vendor':
                if r.lot_id:
                    warranty_claim_policies = r.lot_id.mapped('warranty_claim_policy_ids').filtered(lambda l: l.apply_to == 'purchase')
                    for warranty_claim_policy_id in warranty_claim_policies:
