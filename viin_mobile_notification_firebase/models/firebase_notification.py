...
class FirebaseNotification(models.Model):
    ...
    def _prepare_firebase_request_data(self, list_tokens_silent, list_tokens_noisy):
        ...
        data_notification = safe_eval(self.data)
    ...
    def _validate_firebase_response(self, data):
        ...
        Because firebase return only list of string, we need to check each element in list,
            then map them with list notification detail by index
        ...
        @param {records} notification_details: list record notification detail
        """
        self.ensure_one()
        ...
        for detail in details:
            ...
            device_tokens = detail.partner_id.mobile_token_ids
            ...
            if not message_id and resend:
                ...
                detail_vals['retried_count'] = detail.retried_count + 1
                if detail_vals['retried_count'] >= notify_max_retry:
                    detail_vals['state'] = 'cancelled'
            detail.write(detail_vals)

    def _cancel_notification_firebase(self, list_token, groups=False, notify_ids=False):
        """
