...
class HelpdeskTicketSLA(models.Model):
    ...
    exceeded_days = fields.Float(string='Excedeed Working Days', compute='_compute_exceeded_time', store=True, help="Working days exceeded for reached SLAs compared with deadline.")
