...
class HelpdeskTeam(models.Model):
    ...
    def action_view_all_rating(self):
        ...
        action = self.env['ir.actions.act_window']._for_xml_id('viin_helpdesk.rating_rating_action_view_team')
    ...
    def _alias_get_creation_values(self):
        alias_values = super(HelpdeskTeam, self)._alias_get_creation_values()
        alias_values['alias_model_id'] = self.env['ir.model']._get('helpdesk.team').id
        if self.id:
