odoo.define('viin_helpdesk.rating', function(require) {
    'use strict';

    var time = require('web.time');
    var publicWidget = require('web.public.widget');

    publicWidget.registry.TicketRatingImage = publicWidget.Widget.extend({
        selector: '.o_portal_helpdesk_rating .o_rating_image',
