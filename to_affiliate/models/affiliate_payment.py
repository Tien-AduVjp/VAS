...
class AffiliatePayment(models.Model):
    ...
    user_id = fields.Many2one('res.partner', string="Affiliate", required=True,
    ...
    total = fields.Monetary(string="Commission Total", currency_field='company_currency_id', digits='Account',
    ...
    def action_cancel(self):
        ...
        if non_draft_invoices:
            for invoice in non_draft_invoices:
                if invoice.invoice_payment_state in ['in_payment', 'paid']:
