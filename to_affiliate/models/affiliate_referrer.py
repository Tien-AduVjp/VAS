...
class AffiliateReferrer(models.Model):
    ...
    # TODO: remove this field to use commercial_partner to avoid misunderstanding
    company_id = fields.Many2one('res.partner', related='affcode_id.company_id.partner_id', string='Affiliate Company', store=True, index=True)
