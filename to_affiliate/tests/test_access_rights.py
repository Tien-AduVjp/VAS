...
class TestAccessRights(TestAffiliateCommon):
    ...
    def test_portal_user_access_affcode(self):
        ...
        with self.assertRaises(AccessError):
            self.env['affiliate.code'].with_user(self.user_portal).create({
    ...
    def test_useraff_access_affcode(self):
        ...
        # Result: AccessError
        with self.assertRaises(AccessError):
            affcode_affuser = self.env['affiliate.code'].with_user(self.user_aff).create({
    ...
    def test_affiliate_manager_access_affcode(self):
        ...
        own_aff_code = self.env['affiliate.code'].with_user(self.manager_aff).create({
            'partner_id': self.user_portal.partner_id.id,
        })
        own_aff_code.read([])
