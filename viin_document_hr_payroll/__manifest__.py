{
    ...
    'name_vi_VN': "Quản lý Tài liệu Lương",
...
What it does
============
This bridge module between Document Management System and Payroll.
...
Mô tả
=====
Mô đun cầu nối giữa Quản lý tài liệu và Lương.
...
2. Ấn bản Enterprise
    ...
    'version': '0.1.0',
    'depends': ['viin_document_hr','to_hr_payroll'],
    'data': [
