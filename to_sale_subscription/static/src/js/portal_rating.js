odoo.define('to_sale_subscription.rating', function (require) {
'use strict';

var time = require('web.time');
var publicWidget = require('web.public.widget');

publicWidget.registry.SubscriptionRatingImage = publicWidget.Widget.extend({
    selector: '.o_portal_subscription_rating .o_rating_image',
