...
class SaleOrder(models.Model):
    ...
    loyalty_id = fields.Many2one('loyalty.program', string='Loyalty Program', help="The loyalty program used by this sales order."
    ...
    def _onchange_for_loyalty(self):
        self.update({
            'loyalty_id': self.env['loyalty.program'].find_loyalty_program(self.partner_id, self.team_id)
        })
