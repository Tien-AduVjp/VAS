...
class TestExpensePayroll(SavepointCase):
    ...
    def setUpClass(cls):
        ...
        cls.expense = cls.env['hr.expense'].create({
                ...
                'product_uom_id': cls.env.ref('hr_expense.car_travel').uom_id.id,
                'unit_amount': 999,
    ...
    def test_sheet_state_when_done_payslip(self):
    ...
    def test_compute_is_paid_1(self):
        self.expense_2.sheet_id = self.expense_sheet
        # Sheet contain 2 expense line reimbursed
        self.assertTrue(self.expense_sheet.is_paid)

        # Sheet contain 2 expense line direct payment
        self.expense_sheet.expense_line_ids.write({'reimbursed_in_payslip': False})
