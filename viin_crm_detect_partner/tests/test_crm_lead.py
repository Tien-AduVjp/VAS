...
class TestCrmLead(TransactionCase):
    ...
    def test_recognize_partner_with_email(self):
        ...
        self.assertEqual(self.lead.partner_id.id, self.partner.id)
    ...
    def test_lead_data_after_partner_recognize(self):
        ...
        Expect:
            - Partner phone and mobile is changed
        """
        self.lead.write({
            'email_from': 'test-partner@example.viindoo.com',
            'phone': '0111222333',
        ...
        # Phone and mobile on lead is changed
        self.assertEqual(self.lead.phone, '0123456789')
        self.assertEqual(self.lead.mobile, '0987654321')
