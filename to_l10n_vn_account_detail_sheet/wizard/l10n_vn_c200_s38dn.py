...
class WizardL10n_vnC200_s38dn(models.TransientModel):
    _name = 'wizard.l10n_vn.c200_s38dn'
    _inherit = "account.common.report"
    _description = 'Vietnam C200 S38-DN Report Wizard'
    ...
    def _build_contexts(self, data):
        result = super(WizardL10n_vnC200_s38dn, self)._build_contexts(data)
    ...
    def _print_report(self, data):
        res = self.env.ref('to_l10n_vn_account_detail_sheet.act_report_c200_s38dn').report_action(self, data=data)
        return res
    ...
    def _data_report_excel(self, data):
        ...
        lines = self.env['report.to_l10n_vn_account_detail_sheet.report_c200_s38dn']._get_lines(data)
    ...
    def _export_excel(self, data):
        ...
        for line in data["lines"]:
            if line['type'] == "account_title":
                ...
                worksheet.write('E%s' % row, space + line['name'], table_content_style_left)
