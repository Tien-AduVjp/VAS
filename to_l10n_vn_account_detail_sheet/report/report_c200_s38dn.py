...
class Report_C200_S38dn(models.AbstractModel):
    _name = 'report.to_l10n_vn_account_detail_sheet.report_c200_s38dn'
    _inherit = 'report.l10n_vn.common'
    _description = 'Vietnam C200 S38-DN Report'

    @api.model
    def _get_report_values(self, docids, data=None):
        res = super(Report_C200_S38dn, self)._get_report_values(docids, data)
    ...
    def _get_lines(self, data):
        ...
        for account in sorted_accounts:
            ...
            for line in amls:
                ...
                report_lines.append({
                    'type': 'move_line',
                    'name' : line.sum_name and line.sum_name or '',
