...
class TestInvoiceForm(AssetCommon):
    ...
    def setUpClass(cls, chart_template_ref=None):
        ...
        cls.fixed_asset_analytic_tag = cls.env.ref('l10n_vn_c200.analytic_tag_fixed_assets')
    ...
    def test_01_change_product_on_invoice(self):
        ...
        with move_form.invoice_line_ids.new() as line_form:
            ...
            self.assertEqual(line_form.analytic_tag_ids._get_ids(),
                             [self.fixed_asset_analytic_tag.id]
                             )
