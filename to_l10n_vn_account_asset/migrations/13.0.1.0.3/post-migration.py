...
def _update_analytic_tag_for_depreciation_grouped_lines(env):
    ...
    for a in assets:
        for move in a.depreciation_line_ids.mapped('move_id'):
...
def migrate(cr, version):
    ...
    _update_analytic_tag_for_depreciation_grouped_lines(env)
