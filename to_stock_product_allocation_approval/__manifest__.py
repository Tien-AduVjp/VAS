{
    'name': "Product Warehouses Distribution Request/Approval",
    'old_technical_name': 'to_stock_product_allocation',
    'name_vi_VN': "Đề nghị phân phối sản phẩm giữa các kho",
