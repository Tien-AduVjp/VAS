...
class HrOvertimeReason(models.Model):
    ...
    recognition_mode = fields.Selection(selection_add=[
        ...
        ], ondelete={'attendance_or_timesheet': lambda self: self.company_id.overtime_recognition_mode, 'attendance_and_timesheet': lambda self: self.company_id.overtime_recognition_mode},
