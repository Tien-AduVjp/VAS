...
class TestFleetVehicleTrip(TestCommon):
    ...
    def test_trip_with_cost(self):
        ...
        self.env['fleet.vehicle.log.services'].create(cost_val)
        self.assertEqual(self.trip.log_services_count, 1)
        self.assertEqual(self.trip.log_services_ids.amount, 1000)
