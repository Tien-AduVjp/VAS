...
class TestHelpdeskPortal(HttpSavepointCase, TestHelpdeskCommon):

    @classmethod
    def setUpClass(cls):
        super(TestHelpdeskPortal, cls).setUpClass()

        cls.ticket_name = 'Table legs are unbalanced'

        cls.portal = cls.env.ref('base.demo_user0')
